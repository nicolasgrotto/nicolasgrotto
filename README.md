...
API voltada para manipulação profissional de planilhas, com foco em limpeza, análise, comparação, geração de relatórios e automação de fluxos.

**Destaques:**

* Manipulação de Excel e CSV
* Estrutura pensada para uso profissional
...
Plataforma white-label com foco em cobrança, automação e gestão multi-empresa, pensada para operação real em ambiente SaaS.

**Destaques:**

* Multi-tenant com separação por empresa
* Automação de rotinas e régua operacional
...
Sistema desenvolvido para praticar arquitetura, CRUDs, autenticação e organização de regras de negócio em um cenário financeiro.
...
Aplicação desktop pensada para rotinas administrativas, controle e organização interna.
